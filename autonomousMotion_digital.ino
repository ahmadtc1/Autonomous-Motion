...
//if there are no objects within 30cm, both motors will turn forward
 if (distanceFront > 40) {
...
//forward and stopping the right motor
  ...
  digitalWrite(LeftmotorPin2, HIGH);//set leg 2 of the H-bridge high
  digitalWrite(RightmotorPin3, LOW);//set leg 1 of the H-bridge low
  digitalWrite(RightmotorPin4, LOW);//set leg 2 of the H-bridge LOW
 }
